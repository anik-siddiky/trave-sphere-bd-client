...
const About = () => {
    return (
        <div className='min-h-screen md:px-0 px-4 py-8 md:my-10'>
            <h2 className='text-2xl md:text-3xl font-bold text-center'>Why Travel Sphere?</h2>
            <p className='px-4 md:px-24 lg:px-96 text-center mt-4 text-sm md:text-base'>
            ...
            <div className='my-8 md:my-10 md:space-y-0 space-y-3'>
                ...
                <div className='flex flex-col md:flex-row'>
                    <div className='w-full md:w-1/2 bg-primary p-6 md:p-0 md:flex items-center justify-center order-1 md:order-none'>
                ...
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div className='w-full md:w-1/2 bg-white p-6 md:p-0 md:flex items-center justify-center order-1 md:order-none'>
                        <div className='space-y-3 md:px-8 lg:px-16 xl:px-24 max-w-3xl'>
